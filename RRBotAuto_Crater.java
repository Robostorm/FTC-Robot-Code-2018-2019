...
public class RRBotAuto_Crater extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(goldPos.equals("left")) {
            TurnByGyro(TURN_SPEED, "left", 37);

            Drive.encoder(DRIVE_SPEED, 20, 10.0, this, robot);

            Drive.encoder(DRIVE_SPEED, -14, 5, this, robot);

            TurnByGyro(TURN_SPEED, "left", 43);

            // Step 6: Drive forward 52 inches
            Drive.encoder(DRIVE_SPEED, 42, 10.0, this, robot);

            // Step 7: Turn left 42 degrees
            TurnByGyro(TURN_SPEED, "left", 44);
            ...
            Drive.encoder(DRIVE_SPEED, -69, 10.0, this, robot);
        }
            ...
            Drive.encoder(DRIVE_SPEED, 46, 10.0, this, robot);
            ...
            Drive.encoder(DRIVE_SPEED, 12, 5, this, robot);
            Drive.encoder(DRIVE_SPEED, -5, 5, this, robot);
            TurnByGyro(TURN_SPEED, "left", 88);


            Drive.encoder(DRIVE_SPEED, 43, 10.0, this, robot);

            // Step 7: turn Left 42 degrees
            TurnByGyro(TURN_SPEED, "left", 39);
            ...
            // Step 10: Drive Backward 60 inches
            Drive.encoder(DRIVE_SPEED, -73, 10.0, this, robot);
        }
    }
...
//        if(goldPos.equals("left")) {
//
//            // Step 5: Hit gold marker off tape
...
//
//            // Step 6: Drive forward 52 inches
//            Drive.encoder(DRIVE_SPEED, 49.5, 10.0, this, robot);
//
//            // Step 7: Turn left 42 degrees
//            TurnByGyro(TURN_SPEED, "left", 35);
//
...
//            TurnByGyro(TURN_SPEED, "right", 40);
//            Drive.encoder(DRIVE_SPEED, 20, 5, this, robot);
//            Drive.encoder(DRIVE_SPEED, -13, 5, this, robot);
//            TurnByGyro(TURN_SPEED, "left", 130);
//
//
//            Drive.encoder(DRIVE_SPEED, 56, 10.0, this, robot);
//
//            // Step 7: turn Left 42 degrees
//            TurnByGyro(TURN_SPEED, "left", 35);
//
...
//        }
//        else { //center
//            Drive.encoder(DRIVE_SPEED, 15, 5, this, robot);
//            Drive.encoder(DRIVE_SPEED, -8, 5, this, robot);
//            TurnByGyro(TURN_SPEED, "left", 88);
//
//
//            Drive.encoder(DRIVE_SPEED, 53, 10.0, this, robot);
//
//            // Step 7: turn Left 42 degrees
//            TurnByGyro(TURN_SPEED, "left", 32);
//
//            // Step 8: Drive forward 27 inches
//            Drive.encoder(DRIVE_SPEED, 30, 10.0, this, robot);
//
...
//
//            // Step 10: Drive Backward 60 inches
//            Drive.encoder(DRIVE_SPEED, -71, 10.0, this, robot);
//        }
//    }
